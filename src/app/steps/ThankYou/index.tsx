  ...
  return (
    <article className='md:flex items-center h-full py-14 md:py-0'>
      <div className='text-center h-fit'>
        <picture>
          <img className='m-auto h-14 md:h-20' src="https://raw.githubusercontent.com/andersondavid/frontend-mentor-multi-step-form/main/public/assets/images/icon-thank-you.svg" />
        </picture>
        <div>
